...
Item {
  ...
  function initialize() {
    updateWindows();
    console.log("LabwcService", "Service started");
  }
  ...
  function switchToWorkspace(workspace) {
    console.log("LabwcService", "Workspace switching not supported via ToplevelManager");
  }

  function logout() {
    console.log("LabwcService", "Logout not directly supported");
  }

  function queryDisplayScales() {
    console.log("LabwcService", "Display scale queries not supported via ToplevelManager");
  }
}
