...
local DEFAULT_COLORS = {
  ...
  white = "#ABB2BF",
  black = "#191A21",
  lualine_bg_color = "#010112",
}

local colors = vim.tbl_deep_extend('force', DEFAULT_COLORS, vim.g.turbo_colors or {})
...
M.apply = function()
    ...
    local isItalic = vim.g.turbo_italic_comment == true
	...
	if(vim.g.turbo_transparent_bg == true) then
		highlight("Normal", colors.fg, nil, nil, nil)
	else
		highlight("Normal", colors.fg, colors.bg, nil, nil)
	end
	highlight("NormalFloat", colors.fg, nil, nil, nil)
	...
	highlight("Todo", colors.orange, nil, "bold,italic", nil)
	...
	highlight("ColorColumn", nil, colors.color_column, nil, nil)
	...
	highlight("Search", colors.fg, colors.selection, nil, nil)
	...
	if(vim.g.turbo_show_end_of_buffer == true) then
  ...
  highlight("TSTag", colors.cyan, nil, nil, nil)
	...
	-- Telescope
	highlight("TelescopePromptBorder", nil, nil, nil, nil)
	highlight("TelescopeResultsBorder", nil, nil, nil, nil)
	highlight("TelescopePreviewBorder", nil, nil, nil, nil)
	highlight("TelescopeSelection", nil, colors.selection, nil, nil)
	highlight("TelescopeMultiSelection", colors.purple, colors.selection, nil, nil)
	highlight("TelescopeNormal", colors.white, nil, nil, nil)
